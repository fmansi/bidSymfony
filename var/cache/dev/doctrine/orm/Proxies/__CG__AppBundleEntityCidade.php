...
class Cidade extends \AppBundle\Entity\Cidade implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Cidade' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Cidade' . "\0" . 'nome', '' . "\0" . 'AppBundle\\Entity\\Cidade' . "\0" . 'estado'];
        }
    ...
    public function setId($idcidade)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setId', [$idcidade]);

        return parent::setId($idcidade);
    }
